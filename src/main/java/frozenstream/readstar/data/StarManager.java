...
public class StarManager {
    ...
    public static void RenderStars(Matrix4f projectionMatrix, Matrix4f viewMatrix, float light) {
        if (light > 0.0F) {
            ...
            StarManager.starsBuffer.drawWithShader(viewMatrix, projectionMatrix, GameRenderer.getPositionTexShader());
            VertexBuffer.unbind();
        }
    }
